...
private:
	...
	private:
		...
		void draw_skeleton(IClientEntity* m_entity, Box box);
		...
		void draw_defusing(IClientEntity* m_entity, Box box);
		void draw_inair(IClientEntity* m_entity, Box box);
	};
	...
	void draw_weapons(IClientEntity* m_entity, ClientClass* client_class);
	void draw_grenades(IClientEntity* m_entity, ClientClass* client_class);
	void draw_bomb_planted(IClientEntity* m_entity, ClientClass* client_class);
	void draw_bomb(IClientEntity* m_entity, ClientClass* client_class);
