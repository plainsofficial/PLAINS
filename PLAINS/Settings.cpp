...
void Settings::Update()
{
	...
	visualconfig.player.bSkeleton = Menu::Window.VisualsTab.player.ShowSkeleton.GetState();
	...
	visualconfig.player.bWeaponDisplay = Menu::Window.VisualsTab.player.ShowWeaponDisplay.GetState();
	visualconfig.player.iWeaponDisplayType = Menu::Window.VisualsTab.player.ShowWeaponDisplayType.GetIndex();
	...
	visualconfig.player.bDefusing = Menu::Window.VisualsTab.player.Defusing.GetState();
	visualconfig.player.bInAir = Menu::Window.VisualsTab.player.InAir.GetState();
	...
	visualconfig.player.cSkeletonColor = Menu::Window.VisualsTab.player.SkeletonColor.GetValue();
	...
	visualconfig.bFilterWeapons = Menu::Window.VisualsTab.FilterWeapons.GetState();
	visualconfig.cWeaponsColor = Menu::Window.VisualsTab.WeaponsColor.GetValue();
	visualconfig.bFilterNades = Menu::Window.VisualsTab.FilterNades.GetState();
	visualconfig.cNadesColor = Menu::Window.VisualsTab.NadesColor.GetValue();
	visualconfig.bFilterBomb = Menu::Window.VisualsTab.FilterBomb.GetState();
	visualconfig.cBombColor = Menu::Window.VisualsTab.BombColor.GetValue();
	...
	visualconfig.bRemoveFlash = Menu::Window.VisualsTab.RemoveFlash.GetState();
	...
	visualconfig.bMinecraftMode = Menu::Window.VisualsTab.MinecraftMode.GetState();
	visualconfig.bSkyboxChanger = Menu::Window.VisualsTab.SkyboxChanger.GetState();
	visualconfig.iSkyboxModel = Menu::Window.VisualsTab.SkyboxModel.GetIndex();
