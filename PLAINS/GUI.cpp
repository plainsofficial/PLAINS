...
void CGUI::Draw()
{
	draw.text(10, 10, "PLAINS - devbuild", draw.fonts.menu, Color(255, 255, 255, 220));
	...
	if(ShouldDrawCursor)
	{
		draw.rect(Mouse.x + 1, Mouse.y, 1, 17, Color(255, 255, 255, 255));
		for(int i = 0; i < 11; i++)
		{
			draw.rect(Mouse.x + 2 + i, Mouse.y + 1 + i, 1, 1, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 8, Mouse.y + 12, 5, 1, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 8, Mouse.y + 13, 1, 1, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 9, Mouse.y + 14, 1, 2, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 10, Mouse.y + 16, 1, 2, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 8, Mouse.y + 18, 2, 1, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 7, Mouse.y + 16, 1, 2, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 6, Mouse.y + 14, 1, 2, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 5, Mouse.y + 13, 1, 1, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 4, Mouse.y + 14, 1, 1, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 3, Mouse.y + 15, 1, 1, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 2, Mouse.y + 16, 1, 1, Color(255, 255, 255, 255));
		}

		for(int i = 0; i < 4; i++)
		{
			draw.rect(Mouse.x + 2 + i, Mouse.y + 2 + i, 1, 14 - (i * 2), Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 6, Mouse.y + 6, 1, 8, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 7, Mouse.y + 7, 1, 9, Color(255, 255, 255, 255));
		}

		for(int i = 0; i < 4; i++)
		{
			draw.rect(Mouse.x + 8 + i, Mouse.y + 8 + i, 1, 4 - i, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 8, Mouse.y + 14, 1, 4, Color(255, 255, 255, 255));
			draw.rect(Mouse.x + 9, Mouse.y + 16, 1, 2, Color(255, 255, 255, 255));
		}
	}
}
...
bool CGUI::DrawWindow(CWindow* window, int menu)
{
	if(menu == 1)
	{
		...
		iProportion = iProportion / 2;
		draw.gradient_horizontal(_tab_x + 1, _y + 1, iProportion, 1, Color(72, 222, 212, 255), Color(160, 38, 191, 255));
		draw.gradient_horizontal(_tab_x + 1 + iProportion, _y + 1, iProportion, 1, Color(160, 38, 191, 255), Color(232, 44, 117, 255));
...
void CGUI::SaveWindowState(CWindow* window, std::string Filename)
{
	...
	// Root Element Name
	tinyxml2::XMLElement *Root = Doc.NewElement("PLAINS");
	...
	{
		MessageBox(NULL, "Failed to save config file!", "PLAINS", MB_OK);
	}
}

void CGUI::LoadWindowState(CWindow* window, std::string Filename)
{
	// Lets load the window
	tinyxml2::XMLDocument Doc;
